...
chinese_number = (u'十', u'百', u'千', u'万', u'亿', u'一', u'二', u'三', u'四', u'五',
                  u'六', u'七', u'八', u'九', u'零', u'几')
...
if __name__ == "__main__":
    s = u"hehe, 我爱北京天安门。"
    predicates = {u'zh': is_zh, u'punct': is_punct, u'term': is_terminator}
    fmt_str = ' %2s  %-7s  %-7s  %-7s'
    print( fmt_str % tuple(['char'] + predicates.keys()))
    for c in s:
        print(fmt_str % tuple([c] +
                              [str(pred(c)) for pred in predicates.values()]))
